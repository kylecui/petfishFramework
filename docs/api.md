...
This document is the authoritative reference for the public API of petfishFramework v1.2.0. Every signature, field, and example below is derived from the source code and from the tests that exercise it.
